      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-xl p-6 bg-white hover:border-gray-300 hover:shadow-sm transition">
              <p className="font-semibold text-gray-900">기장 대리 / 신고 대리</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-6 bg-white hover:border-gray-300 hover:shadow-sm transition">
              <p className="font-semibold text-gray-900">양도 · 상속 · 증여</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-6 bg-white hover:border-gray-300 hover:shadow-sm transition">
              <p className="font-semibold text-gray-900">법인 컨설팅 / 가업승계</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-6 bg-white hover:border-gray-300 hover:shadow-sm transition">
              <p className="font-semibold text-gray-900">세무 조사 대응</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-6 bg-white hover:border-gray-300 hover:shadow-sm transition">
              <p className="font-semibold text-gray-900">신용등급 관리</p>
            </div>
          </div>
        </section>
