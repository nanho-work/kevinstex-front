...
export default function Hero() {
  return (
    <section className="w-full bg-gradient-to-l from-blue-400 to-white py-16 px-4 hero-font">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-start mb-2">
        {/* 좌측 문구 */}
        <div className="flex flex-col h-[500px] justify-center space-y-6 ">
          ...
          <p className="text-gray-600 text-lg h-2 max-w-md">
