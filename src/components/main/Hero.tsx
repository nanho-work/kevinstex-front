...
export default function Hero() {
  return (
    <section
      className="w-full hero-font rounded-md bg-cover bg-[position:80%_center] md:bg-center sm:min-h-[500px] md:min-h-[596px]"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 items-center gap-10 py-12">
        ...
        <div className="flex flex-col min-h-[400px] md:h-[500px] justify-center space-y-6">
          <p className="text-sm sm:text-base text-blue-600 font-sm tracking-wide">세금도 간편하게 톡!</p>
          <h1 className="text-3xl sm:text-4xl md:text-7xl font-extrabold leading-tight text-gray-900">
            세금을 그리다<br />
          ...
          <p className="text-gray-900 text-base sm:text-lg max-w-md leading-relaxed">
            <span className="bg-white/80 backdrop-blur-sm px-1.5 rounded">
              복잡한 세무,
            </span>
            <br />
            <span className="bg-white/80 backdrop-blur-sm px-1.5 rounded">
