  ...
  return (
    <div className={`max-w-xl mx-auto mt-10 ${className ?? ''}`}>
      ...
      <p className="text-center text-gray-500 text-base mb-6">
        사업자 <span className="text-blue-600 font-semibold">50%</span>가 평균 
        <br className="block md:hidden" />
        8,950,000원을 환급받습니다.
      </p>
      <div className="space-y-4">
        <a
          href="https://solution.keumbaek.com/new/process1?corpType=corp"
          target="_blank"
        ...
        <a
          href="https://solution.keumbaek.com/new/process1?corpType=priv"
          target="_blank"
          rel="noopener noreferrer"
          className="w-full border-4 border-blue-500 rounded-lg p-6 flex items-center justify-between hover:bg-blue-50 transition-colors"
        >
